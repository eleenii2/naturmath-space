...
import { X, Smartphone, Eye, ChevronRight, Lightbulb } from 'lucide-react';
...
const educationData: Record<string, ShapeEducationData> = {
  persegi: {
    emoji: '🟦',
    shapeName: 'Persegi',
    ...
    >
      ...
      <div className="flex flex-col items-center lg:items-start gap-4 max-w-sm text-center lg:text-left">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 text-white font-black text-xs py-3.5 px-6 rounded-2xl shadow-lg hover:shadow-xl transition-all cursor-pointer tracking-wider uppercase active:scale-[0.97]"
        >
          <Eye size={16} />
          <span>Lihat Langsung di Sini</span>
